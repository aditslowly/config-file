...
icon_fg = as_rgb(color_as_int(Color(255, 199, 153)))  # #FFC799
icon_bg = as_rgb(color_as_int(Color(16, 16, 16)))      # #505050

bat_text_color = as_rgb(color_as_int(Color(255, 255, 255)))   # #FFFFFF
clock_color    = as_rgb(color_as_int(Color(160, 160, 160)))   # #A0A0A0
dnd_color      = as_rgb(color_as_int(Color(255, 128, 128)))   # #FF8080
sep_color      = as_rgb(color_as_int(Color(255, 199, 153)))   # #FFC799
utc_color      = as_rgb(color_as_int(Color(255, 128, 128)))   # #FF8080
